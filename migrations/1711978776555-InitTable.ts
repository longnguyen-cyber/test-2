...
export class InitTable1711978776555 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE health_topic_habits ADD CONSTRAINT FK_b5d2e300256fab060b7efb089a0 FOREIGN KEY (topicId) REFERENCES health_topics(id) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE health_topic_habits DROP FOREIGN KEY FK_b5d2e300256fab060b7efb089a0`,
    );
    await queryRunner.query(
      `ALTER TABLE user_habits DROP FOREIGN KEY FK_0b7d751fc3a1337bc51088a6ac0`,
    );
    await queryRunner.query(`DROP TABLE minings`);
    await queryRunner.query(`DROP INDEX IDX_62125893bc1e5ee43b4295621a ON users`);
    ...
    await queryRunner.query(`DROP INDEX REL_0b7d751fc3a1337bc51088a6ac ON user_habits`);
