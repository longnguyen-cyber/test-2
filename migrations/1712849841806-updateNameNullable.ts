...
export class updateNameNullable1712849841806 implements MigrationInterface {
    name = 'updateNameNullable1712849841806'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` CHANGE \`name\` \`name\` varchar(64) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` CHANGE \`name\` \`name\` varchar(64) NOT NULL`);
